...
<td valign="middle">
    <table width="100%" border="0">
      ...
      <tr>
          <td height="30" class="td">Stock_status</td>
      ...
      <tr>
        <td height="30" valign="middle" class="td">Brand</td>
...
<table width="100%" border="0">
        <xsl:for-each select="product_barcodes/product_barcode">  
         <tr>
            <td height="30" width="30%" valign="middle" class="td">Barcode</td>
        ...
        <tr>
          <td height="30" valign="middle" class="td">Model</td>
        ...
        <tr>
          <td height="30" valign="middle" class="td">Weight</td>
        ...
        <tr>
          <td width="20%"  height="30" valign="middle" class="td">Volume</td>
        ...
        <tr>
          <td height="30" valign="middle" class="td">Description</td>
        ...
        <tr>
          <td height="30" valign="middle" class="td">Port</td>
        ...
        <tr>
          <td height="30" valign="middle" class="td">Zone</td>
        ...
        <tr>
          <td height="30" class="td">Manufacturer</td>
     ...
     <!-- <tr>
        <td height="1" colspan="2"  class="line"></td>
         ...
         <tr>
          <td height="30" valign="middle" class="td">Date_avaliable</td>
