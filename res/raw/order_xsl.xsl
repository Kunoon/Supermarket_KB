...
<xsl:stylesheet version="1.0"
			...
			<xsl:choose>
				<xsl:when test="order_status_id&lt;200 and order_status_id&gt;99">
					<tr height="33" bgcolor="#434F6C">
						<td width="10%" align="left" class="bb">Quote No.</td>
				...
				<xsl:otherwise>
					<tr height="33" bgcolor="#434F6C">
						<td width="10%" align="left" class="bb">Order No.</td>
						<td width="90%" align="center" class="bb">
							<xsl:value-of select="order_id" />
						</td>
					</tr>
					...
					<table width="100%" border="0px" cellspacing="0px" cellpadding="0px">
						<tr>
							<td height="35" colspan="2" valign="middle">
								<span class="td"> Product List</span>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td height="35" colspan="2" valign="middle">
								<span class="td"> Information</span>
							</td>
						</tr>
						<tr>
							<td height="296" colspan="2" valign="top" bgcolor="#CAD9E6">
								<table width="100%" cellspacing="1" style="border: solid 0px #C6D3DF;">
									<!--
										...
										bgcolor="#F9F6EE" class="bi">order_id</td> <td width="65%"
										bgcolor="#FFFFFF"><xsl:value-of select="order_id" /></td> </tr>
									-->
									<tr bgcolor="#EEEDE9">
										<td height="33" width="35%" align="left">Status</td>
										<td width="65%">
											<xsl:value-of select="order_status" />
										</td>
									</tr>
									<tr bgcolor="#FFFFFF">
										<td height="33" align="left">Tel</td>
										<td>
											<xsl:value-of select="telephone" />
										</td>
									</tr>
									<tr bgcolor="#EEEDE9">
										<td height="33" width="35%" align="left">Email</td>
										<td>
											<xsl:value-of select="email" />
										</td>
									</tr>
									<tr bgcolor="#FFFFFF">
										<td height="33" align="left">Shipping Method</td>
										<td>
											<xsl:value-of select="shipping_method" />
										</td>
									</tr>
									<tr bgcolor="#EEEDE9">
										<td height="33" align="left">Payment Method</td>
										<td>
											<xsl:value-of select="payment_method" />
										</td>
									</tr>
									<tr bgcolor="#FFFFFF">
										<td height="33" align="left">Payment Term</td>
										<td>
											Deposit
									...
									<tr bgcolor="#EEEDE9">
										<td height="33" align="left">Shipping Address</td>
										<td>
									...
									<tr bgcolor="#FFFFFF">
										<td height="33" align="left">Payment Address</td>
										<td>
									...
									<tr bgcolor="#FFFFFF">
										<td height="33" align="left">Invoice No.</td>
										<td>
											<xsl:value-of select="invoice_id" />
										</td>
									</tr>
									<tr bgcolor="#EEEDE9">
										<td height="33" align="left">Description</td>
										<td>
									...
									<!--
										...
										class="bi">Comment</td> <td bgcolor="#F2F2F2"><xsl:value-of
										select="history_list/history/comment" /></td> </tr>
									-->
									<tr bgcolor="#FFFFFF">
										<td height="33" align="left">Date Added</td>
										<td>
						...
						<!--
							...
							class="td"> Product list</span></td> </tr> <tr> <td height="110"
							colspan="2" bgcolor="#CAD9E6"> <table width="100%"
						...
						<tr>
							<td height="35" colspan="2" valign="middle">
								<span class="td">History List</span>
							</td>
						</tr>
						<tr>
							<td width="100%" colspan="2" bgcolor="#CAD9E6">
	...
	<xsl:template match="history_list">
		<xsl:for-each select="history">
			<tr class="singleLine">
				<td height="33" width="35%" align="left">Added Date</td>
				<td width="65%">
					<xsl:value-of select="date_added" />
				</td>
			</tr>
			<tr class="doubleLine">
				<td height="33" align="left">Comment</td>
				<td>
